...
This module of the course covers data visualization tools.  We'll learn these tools by studying economic mobility using data from the [Opportunity Insights Project](https://opportunityinsights.org).
...
* [Static Visualizations](https://github.com/jdebacker/CompEcon_Fall19/blob/master/Visualization/StaticVisualization.ipynb)
* [Dynamic Visualizations](https://github.com/jdebacker/CompEcon_Fall19/blob/master/Visualization/DynamicVisualization.ipynb)
